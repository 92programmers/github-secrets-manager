<template>
  <div class="min-h-screen flex items-center justify-center px-6 py-12 lg:px-8">
    <button
      @click="githubLogin"
      class="lx tn yz ze zo adu alm are aru avz awf axu bbm bbs bbw bce big bpp flex justify-center items-center rounded-lg bg-gray-200 px-4 py-2 w-fit hover:bg-gray-400"
    >
